  ...
  return (
    <div className="min-h-screen bg-[var(--color-warm-white)] text-foreground">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <h1 className="text-[26px] leading-tight tracking-[-0.625px] font-bold mb-2">プライバシーポリシー</h1>
        <p className="text-[14px] text-[var(--color-warm-gray-500)] mb-8">Privacy Policy — 最終更新日：2025年4月5日</p>
